...
exports.INITIAL_COUPONS = exports.INITIAL_PRODUCTS = exports.CATEGORIES = void 0;
exports.CATEGORIES = [
    { id: 'all', label: '全部' },
    { id: 'kit', label: '種植套組' },
    { id: 'parts', label: '零配件' },
...
exports.INITIAL_PRODUCTS = [
    ...
    { id: 5, category: 'seeds', name: '羽衣甘藍種子', price: 25, cold: false, emoji: '🌿', img: 'img/products/seeds-cruciferous.png', stock: 0, spec: '嚴選夾鏈袋裝 (50g)', features: ['超級食物之王，富含膳食婚維與高抗氧化成分', '微甜帶有溫和甘藍香氣，嫩葉生食極佳', '本批次熱銷已空，正積極由產地補貨中'] },
    ...
    { id: 9, category: 'seeds', name: '蕎麥種子', price: 10, cold: false, emoji: '🌾', img: 'img/products/seeds-cereal.png', stock: 100, spec: '嚴選夾鏈袋裝 (80g)', features: ['穀類之王，含有蘆丁 (Rutin) 及人體必需胺基酸', '蕎麥幼苗口感清爽、清新微甜，適合生食或榨汁', '種玩極易，適合初學者與兒童綠意體驗'] },
    ...
    { id: 19, category: 'seeds', name: '黃豆種子（小）', price: 20, cold: false, emoji: '🫘', img: 'img/products/seeds-legume.png', stock: 55, spec: '非基因改造黃豆 (150g)', features: ['非基改優質黃豆仁，豆香濃郁，出芽率高', '自製黃豆芽營養價值比黃豆本身更高，好吸收', '豆瓣爽脆，豆柄清甜，富含大豆異黃酮'] },
    ...
    { id: 26, category: 'fresh', name: '蘿蔔嬰', price: 50, cold: true, emoji: '🌱', img: 'img/products/fresh-sprouts.png', stock: 0, spec: '活力保鮮盒 (120g)', features: ['每日清晨手工鮮採，微辣爽口，帶有蘿蔔特有辛香', '適合日式壽司、肉類配菜，具極佳解膩提味效果', '本季供不應求，目前庫存售完，下批3日後採收'] },
    { id: 27, category: 'fresh', name: '苜蓿芽', price: 35, cold: true, emoji: '🌱', img: 'img/products/fresh-sprouts.png', stock: 50, spec: '經濟保鮮盒 (150g)', features: ['最經典的百搭生菜！富含葉綠素與高纖維，低熱量無負擔', '質地細柔，水分充足，口感滑嫩', '適合苜蓿芽手卷、三明治與精力湯'] },
...
exports.INITIAL_COUPONS = [
    { code: 'YOGO2026', type: 'fixed', value: 100, minOrderAmount: 500, expiresAt: '2027-12-31T23:59:59Z', active: true },
    { code: 'SPROUT80', type: 'percent', value: 20, minOrderAmount: 300, expiresAt: '2027-12-31T23:59:59Z', active: true },
    { code: 'FREESHIP', type: 'fixed', value: 0, minOrderAmount: 0, expiresAt: '2027-12-31T23:59:59Z', active: true },
];
